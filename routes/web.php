...
Route::middleware('auth', 'verified', 'xss', 'checkUserStatus')->group(function () {
    ...
    Route::middleware('role:Admin|Nurse|Receptionist|Doctor|Case Manager|Front Desk')->group(function () {
    ...
    Route::middleware('role:Admin')->group(function () {
        ...
        Route::get('frontdesks', [FrontDeskController::class, 'index'])
            ->name('frontdesks.index')
            ->middleware('modules');
        Route::post('frontdesks/{frontdesk}/active-deactive', [FrontDeskController::class, 'activeDeactiveStatus']);
        Route::get('export-frontdesks', [FrontDeskController::class, 'frontDeskExport'])->name('frontdesks.excel');
