...
@role('Admin')
    ...
    {{-- Users --}}
    <li
        class="nav-item {{ Request::is('doctors*', 'users*', 'admins*', 'accountants*', 'nurses*', 'lab-technicians*', 'receptionists*', 'pharmacists*', 'frontdesks.*') ? 'active' : '' }}">
    ...
    <!-- {{-- Front Desk --}}
    <li
        class="nav-item {{ Request::is('frontdesks*') ? 'active' : '' }}">
        <a class="nav-link  d-flex align-items-center py-3" href="{{ route('frontdesks.index') }}">
            <span class="aside-menu-icon me-3">
                <i class="fas fa-user-friends"></i>
            </span>
            <span class="aside-menu-title">{{ __('messages.frontdesk') }}</span>
        </a>
    </li> -->
    ...
    @if ($patientCaseMgt)
        <li
            ...
            <a class="nav-link  d-flex align-items-center py-3" href="{{ $patientCaseMgt }}">
                ...
                <span class="d-none">{{ __('messages.followups') }}</span>
            </a>
        </li>
    @endif
