...
<!-- @role('Admin')
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('frontdesks*', 'admins*', 'accountants*', 'nurses*', 'lab-technicians*', 'receptionists*', 'pharmacists*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('frondesks*') ? 'active' : '' }}" href="{{ route('frontdesks.index') }}">
...
@role('Admin|Pharmacist|Lab Technician')
    @module('Medicine Categories', $modules)
        <li
            class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('categories*', 'medicines*', 'medicine-purchase*', 'used-medicine*', 'medicine-bills*') ? 'd-none' : '' }}">
