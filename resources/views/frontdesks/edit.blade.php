@extends('layouts.app')
@section('title')
    {{ __('messages.frontdesk.edit_frontdesk') }}
@endsection
@section('page_css')
        ...
        <div class="d-flex flex-column livewire-table">
            ...
            <div class="card">
                ...
                <div class="card-body p-12">
                    {{ Form::model($user, ['route' => ['frontdesks.update', $frontdesk->id], 'method' => 'patch', 'files' => 'true', 'id' => 'editFrontdeskForm']) }}

                    @include('frontdesks.edit_fields')
...
@endsection
@section('scripts')
    {{--    assets/js/frontdesks/create-edit.js --}}
