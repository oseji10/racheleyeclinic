<div class="alert alert-danger d-none hide" id="editFrontdeskErrorsBox"></div>
<div class="row">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::email('email', null, ['class' => 'form-control', 'required', 'id' => 'editFrontdeskEmail','placeholder'=>__('messages.user.email')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mobile-overlapping mb-5">
            ...
            <br>
            {{ Form::tel('phone', $frontdesk->user->phone ?? getCountryCode(), ['class' => 'form-control phoneNumber', 'id' => 'editFrontdeskPhoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','placeholder'=>__('messages.user.phone')]) }}
        ...
        <div class="form-group mb-5">
            ...
            <div class="d-flex align-items-center">
                <div class="form-check me-10">
                    <label class="form-label" for="editFrontdeskMale">{{ __('messages.user.male') }}</label>
                    {{ Form::radio('gender', '0', true, ['class' => 'form-check-input', 'id' => 'editFrontdeskMale']) }}
                </div>
                <div class="form-check me-10">
                    <label class="form-label" for="editFrontdeskFemale">{{ __('messages.user.female') }}</label>&nbsp;
                    {{ Form::radio('gender', '1', false, ['class' => 'form-check-input', 'id' => 'editFrontdeskFemale']) }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['placeholder' => __('messages.user.dob'),'id' => 'editFrontdeskBirthDate', 'class' => getLoggedInUser()->thememode ? 'bg-light frontdeskBirthDate form-control' : 'bg-white frontdeskBirthDate form-control', 'autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('blood_group', __('messages.user.blood_group') . ':', ['class' => 'form-label']) }}
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select', 'id' => 'editFrontdeskBloodGroup', 'placeholder' => __('messages.user.select_blood_group')]) }}
        </div>
    </div>
                ...
                <div class="image-picker">
                    ...
                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                        ...
                        <label>
                            ...
                            <input type="file" id="editFrontdeskProfileImage" name="image"
...
<div class="row mt-3">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('address1', isset($frontdesk->address->address1) ? $frontdesk->address->address1 : null, ['class' => 'form-control','placeholder'=>__('messages.user.address1')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('address2', __('messages.user.address2') . ':', ['class' => 'form-label']) }}
            {{ Form::text('address2', isset($frontdesk->address->address2) ? $frontdesk->address->address2 : null, ['class' => 'form-control','placeholder'=>__('messages.user.address2')]) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('city', __('messages.user.city') . ':', ['class' => 'form-label']) }}
            {{ Form::text('city', isset($frontdesk->address->city) ? $frontdesk->address->city : null, ['class' => 'form-control','placeholder'=>__('messages.user.city')]) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('zip', __('messages.user.zip') . ':', ['class' => 'form-label']) }}
            {{ Form::text('zip', isset($frontdesk->address->zip) ? $frontdesk->address->zip : null, ['class' => 'form-control', 'maxlength' => '6', 'minlength' => '6','placeholder'=>__('messages.user.zip')]) }}
        </div>
    </div>
