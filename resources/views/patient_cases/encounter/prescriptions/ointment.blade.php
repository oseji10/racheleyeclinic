...
<body>
    <div class="">
        ...
        <table class="table table-striped" id="dynamicAddRemove" width="100%" border="1">
            ...
            <tr>
                <td>
                    <input type="hidden" value="OINTMENT" name="treatment_type2"/>
