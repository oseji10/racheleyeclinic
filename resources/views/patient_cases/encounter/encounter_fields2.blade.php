<form action="{{ route('encounter.store') }}" method="post">
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('visual_acuity_far_presenting_right', __('messages.case.visual_acuity_far_presenting_right')
            . ':', ['class' => 'form-label']) }}
            <select id="visual_acuity_far_presenting_right" class="select2 form-select"
                name="visual_acuity_far_presenting_right" data-control="select2">
        ...
        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('visual_acuity_far_presenting_left', __('messages.case.visual_acuity_far_presenting_left') .
            ':', ['class' => 'form-label']) }}
            {{-- <span class="required"></span> --}}

            <select id="visual_acuity_far_presenting_left" class="select2 form-select"
                name="visual_acuity_far_presenting_left" data-control="select2">
        ...
        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('visual_acuity_far_pinhole_right', __('messages.case.visual_acuity_far_pinhole_right') . ':',
            ['class' => 'form-label']) }}
            <select id="visual_acuity_far_pinhole_right" class="select2 form-select"
                name="visual_acuity_far_pinhole_right" data-control="select2">
        ...
        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('visual_acuity_far_pinhole_left', __('messages.case.visual_acuity_far_pinhole_left') . ':',
            ['class' => 'form-label']) }}
            <select id="visual_acuity_far_pinhole_left" class="select2 form-select"
                name="visual_acuity_far_pinhole_left" data-control="select2">
        ...
        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('visual_acuity_far_best_corrected_right',
            __('messages.case.visual_acuity_far_best_corrected_right') . ':', ['class' => 'form-label']) }}
            <select id="visual_acuity_far_best_corrected_right" class="select2 form-select"
                name="visual_acuity_far_best_corrected_right" data-control="select2">
        ...
        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('visual_acuity_far_best_corrected_left',
            __('messages.case.visual_acuity_far_best_corrected_left') . ':', ['class' => 'form-label']) }}
            <select id="visual_acuity_far_best_corrected_left" class="select2 form-select"
                name="visual_acuity_far_best_corrected_left" data-control="select2">
        ...
        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('visual_acuity_near_right', __('messages.case.visual_acuity_near_right') . ':', ['class' =>
            'form-label']) }}
            <select id="visual_acuity_near_right" class="select2 form-select" name="visual_acuity_near_right"
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <input class="form-control" type="text" id="intraoccular_pressure_right" name="intraoccular_pressure_right"
                autofocus placeholder="Intraocular Pressure Right" />
        </div>
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <input class="form-control" type="text" id="intraoccular_pressure_left" name="intraoccular_pressure_left"
                autofocus placeholder="Intraocular Pressure Left" />
        </div>
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <textarea class="form-control" rows="4" name="detailed_history_right"
                placeholder="{{ __('messages.case.detailed_history_right') }}"></textarea>
        </div>
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <textarea class="form-control" rows="4" name="detailed_history_left"
                placeholder="{{ __('messages.case.detailed_history_left') }}"></textarea>
        </div>
        {{-- CASE FINDINGS --}}
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <textarea class="form-control" rows="4" name="findings_right"
                placeholder="{{ __('messages.case.findings_right') }}"></textarea>
        </div>
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <textarea class="form-control" rows="4" name="findings_left"
                placeholder="{{ __('messages.case.findings_left') }}"></textarea>
        </div>
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <textarea class="form-control" rows="3" name="eyelid_right"
                placeholder="{{ __('messages.case.eyelid_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('eyelid_left', __('messages.case.eyelid_left') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="eyelid_left"
                placeholder="{{ __('messages.case.eyelid_left') }}"></textarea>
        </div>
        {{-- CONJUNCTIVA --}}
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <textarea class="form-control" rows="3" name="conjunctiva_right"
                placeholder="{{ __('messages.case.conjunctiva_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('conjunctiva_left', __('messages.case.conjunctiva_left') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="conjunctiva_left"
                placeholder="{{ __('messages.case.conjunctiva_left') }}"></textarea>
        </div>
        {{-- CORNEA --}}

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('cornea_right', __('messages.case.cornea_right') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="cornea_right"
                placeholder="{{ __('messages.case.cornea_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('cornea_left', __('messages.case.cornea_left') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="cornea_left"
                placeholder="{{ __('messages.case.cornea_left') }}"></textarea>
        </div>
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <textarea class="form-control" rows="3" name="AC_right"
                placeholder="{{ __('messages.case.AC_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('AC_left', __('messages.case.AC_right') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="AC_left"
                placeholder="{{ __('messages.case.AC_left') }}"></textarea>
        </div>
        {{-- IRIS --}}

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('iris_right', __('messages.case.iris_right') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="iris_right"
                placeholder="{{ __('messages.case.iris_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('iris_left', __('messages.case.iris_left') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="iris_left"
                placeholder="{{ __('messages.case.iris_left') }}"></textarea>
        </div>
        {{-- PUPIL --}}

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('pupil_right', __('messages.case.pupil_right') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="pupil_right"
                placeholder="{{ __('messages.case.pupil_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('pupil_left', __('messages.case.pupil_left') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="pupil_left"
                placeholder="{{ __('messages.case.pupil_left') }}"></textarea>
        </div>
        {{-- LENS --}}

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('lens_right', __('messages.case.lens_right') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="lens_right"
                placeholder="{{ __('messages.case.lens_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('lens_left', __('messages.case.lens_left') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="lens_left"
                placeholder="{{ __('messages.case.lens_left') }}"></textarea>
        </div>
        {{-- VITRREOUS --}}

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('vitreous_right', __('messages.case.vitreous_right') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="vitreous_right"
                placeholder="{{ __('messages.case.vitreous_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('vitreous_left', __('messages.case.vitreous_left') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="vitreous_left"
                placeholder="{{ __('messages.case.vitreous_left') }}"></textarea>
        </div>
        {{-- RETINA --}}

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('retina_right', __('messages.case.retina_right') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="retina_right"
                placeholder="{{ __('messages.case.retina_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('retina_left', __('messages.case.retina_left') . ':', ['class' => 'form-label']) }}
            <textarea class="form-control" rows="3" name="retina_left"
                placeholder="{{ __('messages.case.retina_left') }}"></textarea>
        </div>
        {{-- OTHER FINDINGS --}}
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            'form-label']) }}
            <textarea class="form-control" rows="3" name="other_findings_right"
                placeholder="{{ __('messages.case.other_findings_right') }}"></textarea>
        </div>

        <div class="form-group col-sm-6 mb-5">
            {{ Form::label('other_findings_left', __('messages.case.other_findings_left') . ':', ['class' =>
            'form-label']) }}
            <textarea class="form-control" rows="3" name="other_findings_left"
                placeholder="{{ __('messages.case.other_findings_left') }}"></textarea>
        </div>
        {{-- DRAWING --}}
        <div>
